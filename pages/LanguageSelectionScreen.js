...
const styles = StyleSheet.create({
  MainContainer: { flex: 1, backgroundColor: 'white', alignItems: 'center' },
  textHeading: { color: '#191919', fontSize: 30, textAlign: 'center' },
  img: { width: 64, height: 64, marginTop: 30 },
  elementContainer: {
    width: '100%',
    marginTop: 30,
    alignItems: 'center',
  },
  text: { color: '#191919', fontSize: 25 },
  saparator: {
    height: 0.5,
    width: '60%',
